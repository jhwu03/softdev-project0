...
def home():
    ...
    #VARIABLES TO PASS
    command = "SELECT users.username, blogs.blog_name, entry_text FROM users, blogs, entries WHERE users.user_id = blogs.user_id = entries.user_id AND entries.entry_num = MAX(entries.entry_num);"
